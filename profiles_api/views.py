...
class UserProfileViewSet(viewsets.ModelViewSet):
    ...
    # For search functionality in API
...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    ...
    # IsAuthenticated is the django rest_framework permission which is allow to update only if user is authenticated
    # to allow read even if not authenticate use IsAuthenticatedOrReadOnly class
    permission_classes = (
    ...
    # To customize the login for creating model
